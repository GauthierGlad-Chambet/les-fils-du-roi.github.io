//////////////////////////////////////////////////////////////////////////////////
/////////////// INTEGRATION API D&D - à supprimer dans le futur /////////////////
////////////////////////////////////////////////////////////////////////////////
...
try {
  fetch("https://www.dnd5eapi.co/api/monsters")
    ...
    .then(function (data) {
      const monstre = data.results;
      let html = "";
      monstre.forEach(function (monstre) {
        html += `<li><h3>${
          monstre.name
        }</h3><img src="https://www.dnd5eapi.co/api/images/monsters/${monstre.index.toLowerCase()}.png" alt="Image de ${
          monstre.name
        }" /><p>Représentation d'un(e) ${monstre.name} </p></li>`;
      });
      if (liste) {
